...
#define _Re3DAPI_UNIQUE_NAME(x) TOKENPASTE2(x, __LINE__)

#define Re3D_ADD_COMMANDS(cmdsTab) \
	static re3d::Re3DCommand::CommandList _Re3DAPI_UNIQUE_NAME(_Re3D_auto_obj_add_commands)(cmdsTab,sizeof(cmdsTab)/sizeof(cmdsTab[0]));

#define CMD_BEG() namespace _Re3DAPI_UNIQUE_NAME(_Re3Dcmd) { static re3d::Re3DCommand::Command cmdtab[]={
